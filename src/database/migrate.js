...
// Function to add content review and flag fields (idempotent migrations)
const addContentReviewAndFlagFields = async () => {
  try {
    console.log('\n🔍 Adding content review and flag fields...');
    ...
    `);
    console.log('✓ Added review and flag fields to lessons table');
    ...
    await query(`
      ...
      ADD COLUMN IF NOT EXISTS last_flag_reason TEXT;
    `);
    console.log('✓ Added review and flag fields to test_questions table');
    ...
    await query(`
      ...
      ADD COLUMN IF NOT EXISTS last_flag_reason TEXT;
    `);
    console.log('✓ Added review and flag fields to lesson_workshops table');
    ...
    console.log('✅ Content review and flag fields added successfully!');
  } catch (error) {
